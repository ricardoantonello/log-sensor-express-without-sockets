...
const getSensorReadings = (callback) => {
       sensor.read(11, 4, function (err, temperature, humidity) {
         if (err) {
           ...
           console.log("Erro ao ler sensor em getSensorReadings!")
           return callback(err)
         }
         //If everything went well, call the callback with "null" as the first argument to indicate that there was no error.
